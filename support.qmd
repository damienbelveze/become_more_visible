...
https://literatur.social/@fiee/113764124413099652
...
:::
:::{.fragment .fade-up}
[PCR RR](https://rr.peercommunityin.org) can review your preprint deposited on Zenodo, OSF, etc. and recommend it to friendly journals for publication
:::
...
we will tell more about PCI community later about preprints
:::
...
A rule imposed in 1969 by Franz Ingelfinger, then editor-in-chief of the New England Journal of Medicine, in response to the influx of anonymous editorials published several times in several journals. Ingelfinger imposed that the NEJM should no longer publish any text that had first been published elsewhere. 
The reason given was to limit duplicate publications designed to distort an author's [[bibliometric]] score, and to offer the public only recent, unpublished content. The real reason is to establish an embargo on publications in order to guarantee the income of the journal's shareholders. 
...
**preprint peer review with Peer-Community-In**

![](images/PCI.png)

:::{.notes}
as stated in their Mastodon profile, "PCI is a free, non-profit, supra-journal platform that reviews and recommends preprints across all research fields"
from 2021 to July 2024, PCI received 450 submissions in all disciplines and sent 200 recommendations
:::
## {background-color="#fef1da"}
