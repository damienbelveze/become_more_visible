...
**Twitter : should I go or should I stay?**
...
**STAY**
:::
- all community on one platform
- Ok, Twitter was better before, but my followers are here
- friendly user interface (=I don't want to change for another UI)
:::
:::
:::{.column width="50%"}
:::{.incremental}
...
**LEAVE**
:::
- Twitter's enshitification by Elon Musk (> nov 2022)
- breeding ground for climate denialists herds and far-right wing fake news superspreaders
- Mastodon is open source (no hidden algorithm)
- Mastodon is decentralized
- reduced negativity bias (information gain)
:::
:::
::::
